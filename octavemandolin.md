...
<!-- 
ToDo: take these photos!
{% galleryImage "./img/om_back_outside.jpg", "The finished instrument" %}
{% galleryImage "./img/om_back_outside.jpg", "Stencil on the soundboard" %}
{% galleryImage "./img/om_back_outside.jpg", "Inlaid marquetry on the headstock" %}
-->
{% galleryImage "./img/om_back_outside.jpg", "The back showing jointed strips of sycamore and cherry" %}
...
{% galleryImage "./img/om_top_f_holes.jpg", "The front with f-holes cut out" %}
{% endgallery %}